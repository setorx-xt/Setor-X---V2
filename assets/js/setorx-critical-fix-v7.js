...
(function(){
  ...
  // V8: Toast seguro. Evita erro "window.toast is not a function".
  if (typeof window.toast !== "function") {
    window.toast = function safeSetorXToast(msg) {
      try {
        let box = document.getElementById("setorx-safe-toast");
        if (!box) {
          box = document.createElement("div");
          box.id = "setorx-safe-toast";
          box.className = "setorx-safe-toast";

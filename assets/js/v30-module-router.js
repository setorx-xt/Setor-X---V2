...
(function(){
  ...
  const workspaces = {
    ...
    vade:{title:"Vade Mecum",subtitle:"Lei seca por disciplina, busca, grifos inline, comentários por artigo e revisão.",sections:["vade-mecum"],locked:true,icon:"fa-book-open-reader"},
    lawdry:{title:"Lei Seca",subtitle:"Planos de leitura por lei, dificuldade, calendário, revisões e progresso real.",sections:["lei-seca-pro"],locked:true,icon:"fa-book-bookmark"},
    highlights:{title:"Grifos",subtitle:"Biblioteca de grifos do Vade Mecum.",sections:["biblioteca-grifos"],locked:true,icon:"fa-highlighter"},
  ...
  const order=["access","mentor","command","planning","focus","questions","summaries","vade","lawdry","highlights","revisionsPro","statsPro","simulations","performance","prompts","patents"];
  ...
  function apply(key=keyFromHash(), push=false){
    removeBackup(); ensureHeader(); installNav();
  ...
  function boot(){
    removeBackup(); ensureHeader(); installNav(); bind();
